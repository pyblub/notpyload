...
from pyload.utils.parse import packs
from pyload.utils.purge import uniqify
from pyload.core.api.base import BaseApi
from pyload.core.api.init import requireperm
from pyload.core.datatype.check import OnlineCheck
from pyload.core.datatype.init import DownloadStatus, LinkStatus, Permission
...
class PreDownloadApi(BaseApi):
    ...
    def generate_packages(self, links):
        ...
        """
        result = packs((x, x) for x in links)
        return result
