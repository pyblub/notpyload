...
from pyload.config import InputType
...
def _gen_config_defaults():
    ...
    webui_config = (
        ('server', ('option', 'tornado', 'Server',
                       None, ('tornado', 'bjoern', 'eventlet'), InputType.Str)),
        ('force_server', ('option', 'tornado', 'Force_Server',
                    None, None, InputType.Str)),
        ('host', ('option', '127.0.0.1', 'Host',
                     None, None, InputType.Str)),
        ('port', ('option', 8080, 'Port',
                        None, None, InputType.Int)),
        ('activated', ('option', False, 'Activated',
                       None, None, InputType.Bool)),
        ('prefix', ('option', '', 'Path Prefix',
                          None, None, InputType.Str)),
        ('external', ('option', True, 'External',
                   None, None, InputType.Bool)),
        ('debug', ('option', True, 'Debug',
                       None, None, InputType.Bool))
    )
    ...
    defaults = (
        ...
        # TODO: move to webui
        ('webui', ('section', webui_config, 'Web', None))
    )
    return defaults
