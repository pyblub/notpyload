...
from pyload.core import iface
from pyload.core.__about__ import __credits__, __package__
...
def parse_args(argv=None):
    ...
    ap = argparse.ArgumentParser(
        prog=prog, description=desc, epilog=epilog, add_help=False, argument_default=argparse.SUPPRESS)
